...
def run(trainFile, trainLabelFile, testFile,testLabelFile, groupFile,  suspFile,loss, featureNum, nodeNum):
    ...
    # Network Parameters
    n_hidden_1 = nodeNum # 1st layer number of features                                                                       
    n_hidden_2 = nodeNum # 1st layer number of features                                                                       
    n_input = featureNum # number of input features
    ...
    regularizer = (tf.nn.l2_loss(weights['h1'])+tf.nn.l2_loss(weights['h2'])+tf.nn.l2_loss(weights['out'])) * L2_value   # l2 regularization                   
