...
def readDeepResult(dir,subs,tech,dnns,epoch,vers,resultBysub,techsvector):
...
def main():       
    ...
    dnns=['mlp','mlp2','rnn','birnn']
    techsvector=[dnns[0],dnns[1],dnns[2],dnns[3]]
    ...
    truevers=readDeepResult(DeepDataDir,subs,tech,dnns,epochnumber,vers,resultBysub,techsvector)
    ...
    for sub in range(0,7):   # chart,time...overall
        sys.stdout.write(subs.index(sub))
